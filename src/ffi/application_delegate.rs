...
pub type SbApplicationDelegateContextHook = unsafe extern "C" fn(context: *mut c_void);

unsafe extern "C" {
    pub fn sb_application_delegate_create(
        context: *mut c_void,
        callback: SbApplicationDelegateCallback,
        retain_context: SbApplicationDelegateContextHook,
        release_context: SbApplicationDelegateContextHook,
